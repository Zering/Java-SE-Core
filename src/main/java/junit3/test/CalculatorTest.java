...
public class CalculatorTest extends TestCase {
    ...
    public void testAdd1() {
        System.out.println("测试1开始：" + "线程[" + Thread.currentThread().getName() + "], 所处类信息 " + toString());
        calculator.add(10);
    ...
    public void testAdd2() {
        System.out.println("测试2开始：" + "线程[" + Thread.currentThread().getName() + "], 所处类信息 " + toString());
        calculator.add(15);
        calculator.add(20);
    ...
    public static void main(String[] args) {
        ...
        for (TestFailure failure : tr.getFailures()) {
            System.out.println(failure.getFailedTest() + " : " + failure.getThrownException().getMessage());
        }
